        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3 pt-4">
            <button
              onClick={onResume}
              disabled={isLoading}
              className="w-full px-4 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-slate-900 font-medium hover:from-amber-400 hover:to-orange-400 transition-all disabled:opacity-50 flex items-center justify-center gap-3 shadow-lg shadow-amber-500/20"
            >
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={onDiscard}
                disabled={isLoading}
                className="px-4 py-3 rounded-xl bg-slate-700 text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-colors disabled:opacity-50"
